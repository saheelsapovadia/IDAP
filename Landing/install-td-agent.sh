...
sh <<SCRIPT
    ...
    curl -o td-agent-apt-source.deb https://packages.treasuredata.com/4/ubuntu/jammy/pool/contrib/f/fluentd-apt-source/fluen
td-apt-source_2020.8.25-1_all.deb
